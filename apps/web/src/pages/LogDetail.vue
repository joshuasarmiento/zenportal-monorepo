...
<template>
  <div class="h-full flex flex-col font-inter bg-slate-50 overflow-hidden">
    
    <header class="bg-white border-b border-gray-200 p-6 flex items-center gap-4">
      ...
      <div>
        ...
        <p v-if="log" class="text-sm text-gray-500">Posted on {{ log.date }}</p>
      </div>
    </header>
    ...
    <main class="flex-1 overflow-y-auto p-8">
      ...
      <div v-else-if="log" class="max-w-3xl mx-auto space-y-6">
