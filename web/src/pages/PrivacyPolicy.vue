      ...
      <div class="grid gap-12">
        ...
        >
          ...
          <section class="space-y-4">
            ...
            <p>
              <strong class="text-zinc-900 dark:text-white">You are the Data Controller:</strong> You input data about
              your clients. You are responsible for ensuring you have the legal right to input that data.
              <br />
              <strong class="text-zinc-900 dark:text-white">We are the Data Processor:</strong> We provide the
              infrastructure (ZenPortal) to store and display that data.
            </p>
          </section>

          <section class="space-y-4">
            <h2 class="text-2xl font-semibold tracking-tight text-zinc-900 dark:text-white">2. Information We Collect
            </h2>
            <ul class="list-disc pl-5 space-y-2 marker:text-zinc-300 dark:marker:text-zinc-700">
              <li><strong class="text-zinc-900 dark:text-white">Account Info:</strong> Email/Name</li>
              <li><strong class="text-zinc-900 dark:text-white">Professional Profile:</strong> Bio, Headlines, and
                Social Links you choose to display publicly.</li>
              <li><strong class="text-zinc-900 dark:text-white">Billing Info:</strong> Stored securely by PayMongo. We
                never see your card number.</li>
              <li><strong class="text-zinc-900 dark:text-white">Client Data:</strong> Names, work logs (including
                videos/attachments), and client contacts.</li>
            </ul>
          </section>
          ...
          <section class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
              <div
                class="p-4 border border-zinc-200 dark:border-zinc-800 rounded-lg text-sm bg-zinc-50 dark:bg-zinc-900">
                <strong class="text-zinc-900 dark:text-white">Turso</strong> (Database)
              </div>
              <div
                class="p-4 border border-zinc-200 dark:border-zinc-800 rounded-lg text-sm bg-zinc-50 dark:bg-zinc-900">
                <strong class="text-zinc-900 dark:text-white">Better Auth</strong> (Auth)
              </div>
              <div
                class="p-4 border border-zinc-200 dark:border-zinc-800 rounded-lg text-sm bg-zinc-50 dark:bg-zinc-900">
          ...
          <section class="space-y-4">
            ...
            <p>
              If you cancel, your data is soft-deleted. If you request permanent deletion, we will wipe your data from
              active databases within 30 days. Backups may persist for up to 90 days for disaster recovery.
            </p>
          </section>
          ...
          <section class="space-y-4">
            ...
            <p>
              We maintain reasonable administrative, technical, and physical safeguards. However, no service is 100%
              secure. You accept that using an online service involves inherent risks.
            </p>
          </section>
          ...
          <section class="space-y-4">
            ...
            <p>
              <a href="mailto:support@zenportal.com.ph"
                class="text-blue-600 dark:text-blue-400 hover:underline underline-offset-4 decoration-blue-200">support@zenportal.com.ph</a>
            </p>
          </section>
