  ...
  <div
    ...
    <section class="relative pb-20">
      <div class="max-w-7xl mx-auto px-6 text-center relative z-10">
        ...
        <div class="flex justify-center mb-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
          <div
            class="inline-flex items-center rounded-full border border-blue-500/30 bg-blue-500/10 px-4 py-1.5 text-sm backdrop-blur-sm">
        ...
        <h1
          class="text-5xl md:text-7xl lg:text-8xl font-black tracking-tight text-zinc-900 dark:text-white mb-8 text-balance leading-[0.95]">
          Hindi ka lang <span
            class="text-transparent bg-clip-text bg-linear-to-r from-zinc-400 to-zinc-600 decoration-zinc-500 line-through decoration-4">Employee.</span><br />
          <span
            class="text-transparent bg-clip-text bg-linear-to-r from-blue-600 via-cyan-600 to-emerald-600 dark:from-blue-400 dark:via-cyan-400 dark:to-emerald-400 glow-text">Business
            Partner</span> ka.
        </h1>

        <p class="text-xl md:text-2xl text-zinc-600 dark:text-zinc-400 mb-10 max-w-3xl mx-auto leading-relaxed">
          Stop acting like a <span class="text-zinc-900 dark:text-white font-semibold">$3/hr assistant</span>. Use the
          tools that top-tier Filipino freelancers use to manage clients, track work, and get paid what they deserve.
        </p>

        <div class="flex flex-col sm:flex-row justify-center gap-4 mb-20">
          <Button size="lg"
            class="h-16 px-10 text-lg rounded-full bg-blue-600 hover:bg-blue-500 text-white shadow-[0_0_40px_-10px_rgba(37,99,235,0.5)] transition-all duration-300 hover:scale-105"
            as-child>
            <router-link to="/pricing">Create Your Portal
              <ArrowRight class="ml-2 h-5 w-5" />
            </router-link>
          </Button>
          <div
            class="flex items-center gap-4 text-sm text-zinc-600 dark:text-zinc-500 justify-center mt-2 sm:mt-0 px-4">
            <div class="flex -space-x-3">
              <Avatar class="border-2 border-white dark:border-zinc-950 h-10 w-10">
        ...
        <div class="relative w-full max-w-6xl mx-auto group perspective-1000">
          <div
            class="absolute -inset-4 bg-linear-to-t from-blue-600/20 via-purple-600/20 to-transparent rounded-4xl blur-2xl opacity-50 group-hover:opacity-75 transition duration-1000">
          </div>

          <div
            class="relative rounded-2xl border border-zinc-200 dark:border-white/10 bg-white/50 dark:bg-zinc-950/80 backdrop-blur-md shadow-2xl overflow-hidden transform transition-transform duration-500 hover:rotate-x-2">

            <div
              class="border-b border-zinc-200 dark:border-white/10 bg-zinc-50/80 dark:bg-black/40 p-4 flex items-center justify-between">
                  ...
                  <div
                    ...
                    <div class="grid flex-1 text-left text-sm leading-tight">
                      <span class="truncate font-bold text-blue-600 dark:text-blue-400">ZenPortal<span
                          class="text-zinc-400 dark:text-zinc-600">.io</span></span>
    ...
    <section class="py-32 relative bg-zinc-50 dark:bg-black/20">
      <div class="max-w-6xl mx-auto px-6">
        <div class="text-center mb-20">
          <Badge variant="outline"
            class="mb-4 border-red-500/30 text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900/10">Reality Check
          </Badge>
          <h2 class="text-3xl md:text-5xl font-bold mb-6 tracking-tight text-zinc-900 dark:text-white">Anong klaseng VA
            ka?</h2>
          <p class="text-xl text-zinc-600 dark:text-zinc-400">Clients pay cheap for "employees." They pay premium for
            "peace of mind."</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch relative">
          ...
          <div
            class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-20 hidden md:flex h-14 w-14 items-center justify-center rounded-full bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-white/10 shadow-2xl font-black text-sm text-zinc-500">
            VS</div>

          <Card
            class="relative border-zinc-200 dark:border-white/5 bg-white dark:bg-white/5 hover:bg-red-50 dark:hover:bg-red-500/5 transition-colors duration-500 group overflow-hidden shadow-lg dark:shadow-none">
            <CardHeader>
              <div class="flex items-center justify-between">
                <span
                  class="text-sm font-bold uppercase tracking-widest text-zinc-500 group-hover:text-red-500 dark:group-hover:text-red-400 transition-colors">The
                  Typical "Yes Sir" VA</span>
            ...
            <CardContent class="p-8 pt-0">
              ...
              <p
                class="mt-8 text-sm font-medium text-red-600 dark:text-red-400/90 border-t border-zinc-100 dark:border-white/5 pt-4">
          ...
          <Card
            class="relative border-blue-500/30 bg-blue-50 dark:bg-blue-600/5 shadow-[0_0_40px_-10px_rgba(59,130,246,0.1)] overflow-hidden">
            <div class="absolute inset-0 bg-linear-to-br from-blue-500/10 to-transparent"></div>
            <CardHeader class="relative z-10">
              <div class="flex items-center justify-between">
                <span class="text-sm font-bold uppercase tracking-widest text-blue-600 dark:text-blue-400">The Strategic
                  Partner</span>
            ...
            <CardContent class="relative z-10 p-8 pt-0">
              ...
              <p
                class="mt-8 text-sm font-medium text-blue-700 dark:text-blue-300 border-t border-blue-200 dark:border-blue-500/20 pt-4">
    ...
    <section class="py-24 px-6 max-w-7xl mx-auto">
      <div class="text-center mb-16">
        <h2 class="text-3xl md:text-4xl font-bold tracking-tight mb-4 text-zinc-900 dark:text-white">Diskarteng Pinoy,
          World-Class Tech</h2>
        <p class="text-zinc-600 dark:text-zinc-400">Built for the specific needs of Filipino freelancers working with
          Western clients.</p>
      </div>
      <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        <Card v-for="(feature, idx) in features" :key="idx"
          :class="['bg-white dark:bg-zinc-900/50 border-zinc-200 dark:border-white/5 hover:border-blue-500/30 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 overflow-hidden group', feature.class]">
          <CardHeader>
    ...
    <section class="py-24 px-6 max-w-3xl mx-auto">
      <div class="text-center mb-12">
        <div
          class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-500/10 text-purple-600 dark:text-purple-400 text-xs font-bold uppercase tracking-wider mb-4">
      ...
      <Accordion type="single" collapsible class="w-full space-y-4">
        <AccordionItem v-for="(faq, index) in faqs" :key="index" :value="`item-${index}`"
          class="border border-zinc-200 dark:border-white/10 rounded-lg bg-white dark:bg-white/5 px-4 data-[state=open]:border-blue-500/30 data-[state=open]:bg-blue-50/50 dark:data-[state=open]:bg-blue-900/10 transition-all">
          <AccordionTrigger
            class="text-left text-lg font-medium text-zinc-800 dark:text-zinc-200 hover:text-blue-600 dark:hover:text-white hover:no-underline py-6">
            {{ faq.question }}
          </AccordionTrigger>
          <AccordionContent
            class="text-zinc-600 dark:text-zinc-400 leading-relaxed text-base pb-6 border-t border-zinc-100 dark:border-white/5 pt-4 mt-2">
            {{ faq.answer }}
          </AccordionContent>
        </AccordionItem>
      </Accordion>
    ...
    <section class="py-32 px-6 relative overflow-hidden bg-zinc-900 dark:bg-black">
      ...
      <div class="max-w-4xl mx-auto text-center relative z-10">
        ...
        <div class="flex flex-col items-center gap-4">
          <Button size="lg"
            class="h-16 px-12 text-xl font-bold rounded-full bg-white text-blue-900 hover:bg-zinc-200 shadow-[0_0_50px_-10px_rgba(255,255,255,0.3)] transition-transform hover:scale-105"
            as-child>
